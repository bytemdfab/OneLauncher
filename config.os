...
Функция КодДоступа(Знач КодДоступа = "") Экспорт
	
	мПараметрыЗапуска.Вставить("ИспользоватьКодДоступа", Истина);
	Если ЗначениеЗаполнено(КодДоступа) Тогда
		мПараметрыЗапуска.Вставить("КодДоступа", КодДоступа);
	КонецЕсли;
...
Функция КоманднаяСтрока() Экспорт
	...
	Если мПараметрыЗапуска.Свойство("ВерсияПлатформы") Тогда
		Состав.Добавить(ПолучитьПутьКВерсииПлатформы(мПараметрыЗапуска.ВерсияПлатформы));
	ИначеЕсли мПараметрыЗапуска.Свойство("ПутьКПлатформе") Тогда
	...
	Если мПараметрыЗапуска.Свойство("ИспользоватьКодДоступа") И мПараметрыЗапуска.ИспользоватьКодДоступа Тогда
		
		Состав.Добавить("/UC");
		
		Если мПараметрыЗапуска.Свойство("КодДоступа") Тогда
			Состав.Добавить(мПараметрыЗапуска.КодДоступа);
		КонецЕсли;
	КонецЕсли;
